return {
	...
	-- 								on_attach = lsp_attach, -- Use your existing on_attach function
	-- 								filetypes = { 'sh', 'bash', 'zsh' }, -- Add 'zsh' to the filetypes
	-- 								-- Add any bashls specific settings here if needed
	-- 							})
	-- 							return -- Return after setting up bashls
	-- 						end
	--
